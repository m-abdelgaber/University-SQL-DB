...
<body style="margin-left:73px">
    <form id="form1" runat="server" >
        ...
        <br />
        <br />
        <asp:Button ID="AddPhoneN" runat="server"  Font-Bold="true" Font-Size="XX-Large" style="margin-left: 280px" Text ="Add phone number" Width="600" OnClick="AddPhoneN_Click"/>
