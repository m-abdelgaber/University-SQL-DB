...
namespace GUCera.Instructor
{
    public partial class issueCertificate : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            calcGrade.Parameters.Add(new SqlParameter("@sid",sid));
            calcGrade.Parameters.Add(new SqlParameter("@cid", cid));
            calcGrade.Parameters.Add(new SqlParameter("@insId", Session["userId"]));
